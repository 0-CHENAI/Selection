...
We take security seriously. If you discover a security vulnerability in Selection, please report it responsibly.
...
- The Selection desktop application
- The application packages in this repository
- Official Selection product sources
