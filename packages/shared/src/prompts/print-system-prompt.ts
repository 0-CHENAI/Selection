#!/usr/bin/env bun
/**
 * Debug script to print the full Selection system prompt with annotations.
...
printAnnotation('  2. Selection Environment Marker - version, platform, arch');
...
${colors.bold}SDK Configuration:${colors.reset}
  ...
  systemPrompt.append: getSystemPrompt() ${colors.dim}// Selection additions (static, cacheable)${colors.reset}
...
${colors.bold}Static System Prompt Components:${colors.reset}
  ...
  2. Selection Environment Marker      ${colors.dim}// Version, platform, arch${colors.reset}
