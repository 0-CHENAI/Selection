...
describe('system prompt guidance', () => {
  ...
  it('treats OfficeCLI as a native capability rather than a skill', () => {
    ...
    expect(prompt).toContain('None requires loading a skill')
    expect(prompt).toContain('internal runtime capabilities, not skills')
    ...
    expect(prompt).toContain('deliveryReady means Selection\'s machine gates passed')
