...
// Documentation is served via local files at ~/.selection/docs/
...
export class ClaudeAgent extends BaseAgent {
  ...
  protected async *chatImpl(
    ...
    try {
      ...
      // Gated by enable1MContext in global config (~/.selection/config.json).
            ...
            if (inactiveSourceError && this.onSourceActivationRequest) {
              ...
              try {
                ...
                if (activated) {
                  ...
                  // Yield source_activated for auto-retry. Prefer the captured
                  // user-facing message (no system-reminder / model directives).
                  yield {
