...
const EXPECTED_CHANNELS: string[] = [
  ...
  'resources:copyBetweenWorkspaces',
  'resources:export',
  'resources:import',
  'resources:importMcpJson',
  'resources:importSkillFile',
  'resources:openBundleFile',
  'resources:openMcpJsonFile',
  'resources:openSkillImportFile',
  'resources:previewImport',
  'resources:previewMcpJson',
  'resources:previewSkillFile',
  'resources:saveBundleFile',
  ...
  'session:event',
  'session:getModel',
  'session:getSwarmRunDetails',
  'session:setModel',
  'session:setSwarmEnabled',
  'session:stopSwarm',
  'session:updateSwarmBudget',
  'sessions:cancel',
  'sessions:command',
  'sessions:create',
  'sessions:delete',
  ...
  'settings:getSharedProjectMemoryEnabled',
  'settings:setAnySearchApiKey',
  'settings:setDagOrchestrationEnabled',
  'settings:setDefaultThinkingLevel',
  'settings:setNetworkProxy',
  'settings:setServerConfig',
  'settings:setSharedProjectMemoryEnabled',
  'settings:setSwarmAgentsEnabled',
  ...
  'sources:retryConnection',
  'sources:saveCredentials',
  'sources:setDisplayTitle',
  'sources:startOAuth',
  'statuses:changed',
  'statuses:list',
  'statuses:reorder',
