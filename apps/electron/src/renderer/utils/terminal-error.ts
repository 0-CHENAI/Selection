const terminalCodes = new Set<string>([
  'answer_delivery_missing', 'answer_persistence_failed', 'progress_needs_user', 'output_limit', 'call_time_limit', 'provider_timeout', 'no_response', 'tool_only_response', 'context_limit', 'stream_interrupted', 'agent_process_exited',
])
