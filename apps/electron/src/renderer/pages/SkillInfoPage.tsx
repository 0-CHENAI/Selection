...
export default function SkillInfoPage({ skillSlug, workspaceId, workingDirectory }: SkillInfoPageProps) {
  ...
  useEffect(() => {
    ...
    const loadSkill = async (showLoading = false) => {
    ...
    // Broadcast payloads can belong to a different task working directory.
    // Re-read this page's scoped catalog and also clear stale deleted Skills.
