...
function AppShellContent({
  ...
  React.useEffect(() => {
    ...
    // Skill change broadcasts are workspace-scoped, while project Skills depend
    // on the active task's working directory. Treat the broadcast as an
    // invalidation signal and re-read the correctly scoped list instead of
    // trusting a list produced for whichever session performed the write.
