...
Use `browser_tool` to control built-in browser windows (Chromium) inside Selection.
...
- Before first browser tool usage, the agent must read this guide (`~/.selection/docs/browser-tools.md`).
