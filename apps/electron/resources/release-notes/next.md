...
- **Selection branding now anchors the primary sidebar** — The supplied swan mark and CATHALIE Selection name stay visible above the relocated New Session action, with dedicated light and dark artwork. Conversation content keeps its full working area without repeating the wordmark. ([#275](https://github.com/0-CHENAI/Selection/issues/275))
