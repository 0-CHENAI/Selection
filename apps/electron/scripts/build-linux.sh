...
echo "=== Building Selection AppImage (${ARCH}) using electron-builder ==="
if [ "$UPLOAD" = true ]; then
...
# electron-builder outputs: Selection-x86_64.AppImage or Selection-aarch64.AppImage
BUILT_APPIMAGE_NAME="Selection-${LINUX_ARCH}.AppImage"
...
# Rename to our standard naming convention: Selection-x64.AppImage, Selection-arm64.AppImage
APPIMAGE_NAME="Selection-${ARCH}.AppImage"
