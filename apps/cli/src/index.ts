#!/usr/bin/env bun
/**
 * craft-cli — Terminal client for Selection server.
 *
 * Connects over WebSocket (ws:// or wss://) to a running Selection server
...
function printHelp(): void {
  process.stdout.write(`craft-cli — Terminal client for Selection server
