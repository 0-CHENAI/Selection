...
$process = Get-Process -Name "Selection" -ErrorAction SilentlyContinue
if ($process) {
    Write-Info "Closing Selection..."
...
$binDir = "$env:LOCALAPPDATA\Selection\bin"
$cmdFile = "$binDir\craft-agents.cmd"
$exePath = "$env:LOCALAPPDATA\Programs\Selection\Selection.exe"
...
Write-Host ""
Write-Host "  Selection has been installed."
Write-Host ""
